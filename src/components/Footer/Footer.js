        ...
        <div className='footer'>
            <div className='container'>
                ...
                <div className='footer2'>
                    <div className='term'>
                        <p className='col'>
                            <a href='https://augmind.me/' target='_black'>Powered by Augmind labs</a>
                        </p>
                        <img src={logo} />
                    </div>
                    <div className='col gen'><a href='#'>© 2022 CARLGALLERYCLUB</a></div>
                </div>
            </div>
        </div>
    )
